...
namespace ExcelToTxt
{
    public partial class Frm_Main : Form
    {
        ...
        {
            //连接Excel数据库
            OleDbConnection olecon = new OleDbConnection("Provider=Microsoft.Ace.OleDB.12.0;Data Source=" + txt_Path.Text + ";Extended Properties=Excel 8.0");
            olecon.Open();//打开数据库连接
        ...
        private void CBoxBind()//对下拉列表进行数据绑定
        {
            ...
            //连接Excel数据库
            OleDbConnection olecon = new OleDbConnection("Provider=Microsoft.Ace.OleDB.12.0;Data Source=" + txt_Path.Text + ";Extended Properties=Excel 12.0");
            olecon.Open();//打开数据库连接
